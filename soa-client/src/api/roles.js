...
export function rolesLista(query) {
  ...
  return request({
    url   : process.env.VUE_APP_API_RUTA_ROLES + '/lista',
    method: 'get',
    params: query
  }, function (err) {
    return err
...
export function rolesMantenimiento(data) {
  data.token    = getToken()
  ...
  return request({
    url   : process.env.VUE_APP_API_RUTA_ROLES + '/mantenimiento',
    method: 'post',
    data
  }, function (err) {
    return err
